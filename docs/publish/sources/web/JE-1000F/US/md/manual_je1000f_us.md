...
<img src="assets/lcd_map_f82efe218bc0.png" style="width: 420px;" width="420" height="248" alt="LCD DISPLAY" />
...
<figure aria-label="LCD display mode placeholder." class="hb-lcd-mode-composition"><div class="hb-lcd-mode-art-panel"><img alt="LCD display mode placeholder." class="hb-lcd-mode-art" src="assets/op_lcd_mode_7a44a5af8097.png"/></div><div class="hb-lcd-mode-table-panel"><table class="hb-lcd-mode-table"><colgroup><col class="hb-lcd-mode-col-state"/><col class="hb-lcd-mode-col-action"/><col class="hb-lcd-mode-col-copy"/></colgroup>
<tr>
...
<img src="assets/op_ups_mode_e8803f665abb.png" style="width: 360px;" width="360" height="202" alt="UPS connection diagram placeholder." />
...
<img src="assets/ac_wall_37f4c64bfeaa.png" style="width: 360px;" width="360" height="144" alt="AC wall charging diagram placeholder." />
...
<img src="assets/solar_direct_8332edf8c767.png" style="width: 360px;" width="360" height="158" alt="Solar charging connection diagram placeholder 1." />
...
<img src="assets/solar_adapter_cebf89383670.png" style="width: 360px;" width="360" height="166" alt="Solar charging connection diagram placeholder 2." />
...
<figure aria-label="1. Download the App and log in" class="hb-app-download-composition"><div class="hb-app-download-grid"><div class="hb-app-download-column hb-app-download-column-store"><div class="hb-app-download-art-frame"><img alt="" aria-hidden="true" class="hb-app-download-art hb-app-download-art-store" loading="lazy" src="assets/app_store_badges_1c7bfea9e26b.png"/></div><div class="hb-app-download-copy hb-app-download-copy-store"><p>Search for "Jackery" in Google Play or App Store to install the App. After that, you can register and log in.</p></div></div><div class="hb-app-download-column hb-app-download-column-qr"><div class="hb-app-download-art-frame"><img alt="" aria-hidden="true" class="hb-app-download-art hb-app-download-art-qr" loading="lazy" src="assets/app_download_qr_5f2a58121306.png"/></div><div class="hb-app-download-copy hb-app-download-copy-qr"><p>Alternatively, scan the QR code below to download and install the App.</p></div></div></div><div class="hb-app-download-semantic"><img alt="App download QR and marketplace placeholder." class="hb-app-download-semantic-art" src="assets/download_37bf4f4918f3.png" style="width: 320px;" width="320" height="65" /></div></figure>
...
<img src="assets/lcd_map_f82efe218bc0.png" style="width: 420px;" width="420" height="248" alt="AFFICHAGE LCD" />
...
<figure aria-label="Mode d'affichage LCD." class="hb-lcd-mode-composition"><div class="hb-lcd-mode-art-panel"><img alt="Mode d'affichage LCD." class="hb-lcd-mode-art" src="assets/op_lcd_mode_7a44a5af8097.png"/></div><div class="hb-lcd-mode-table-panel"><table class="hb-lcd-mode-table"><colgroup><col class="hb-lcd-mode-col-state"/><col class="hb-lcd-mode-col-action"/><col class="hb-lcd-mode-col-copy"/></colgroup>
<tr>
...
<img src="assets/op_ups_mode_e8803f665abb.png" style="width: 360px;" width="360" height="202" alt="Schéma de connexion ASI." />
...
<img src="assets/ac_wall_37f4c64bfeaa.png" style="width: 360px;" width="360" height="144" alt="Schéma de charge sur prise murale CA." />
...
<img src="assets/solar_direct_8332edf8c767.png" style="width: 360px;" width="360" height="158" alt="Schéma de connexion pour la charge solaire 1." />
...
<img src="assets/solar_adapter_cebf89383670.png" style="width: 360px;" width="360" height="166" alt="Schéma de connexion pour la charge solaire 2." />
...
<img src="assets/lcd_map_f82efe218bc0.png" style="width: 420px;" width="420" height="248" alt="PANTALLA LCD" />
...
<figure class="hb-operation-figure hb-operation-layout-status-right hb-has-composite-art" data-operation-id="dc-usb-output" data-source-fragment-sha256="27e2bc835766afe080395ab6885c86a1b8a1f3f8694f7a370a3444bd3e8cca83" data-web-replace-key="operation.dc-usb-output"><div aria-hidden="true" class="hb-composite-stage"><img alt="" class="hb-composite-art" loading="lazy" src="assets/operation.dc-usb-output_es_3c0d7f87bdce_3c0d7f87bdce.png"/></div><div class="hb-operation-stage"><img alt="Operación de salida de CC y USB." class="hb-operation-art" src="assets/op_dc_usb_output_c46c92d6ee99.png" style="width: 360px;" width="360" height="208" /><div class="hb-operation-prerequisite" data-callout-id="operation.dc-usb-output.prerequisite" style="--hb-x:1.5%;--hb-y:1.5%;--hb-width:46%;--hb-height:8.5%"><p><strong>Requisito previo:</strong> el producto está encendido.</p></div><div class="line-block hb-operation-steps" data-callout-id="operation.dc-usb-output.steps" style="--hb-x:79%;--hb-y:16%;--hb-width:19%;--hb-height:26%"><div class="hb-operation-step" data-callout-id="operation.dc-usb-output.on" data-step-id="on"><div class="line" data-step-id="on" data-step-part="label"><strong>Encendido</strong></div><div class="line" data-step-id="on" data-step-part="instruction">Presione una vez</div></div><div class="hb-operation-step" data-callout-id="operation.dc-usb-output.off" data-step-id="off"><div class="line" data-step-id="off" data-step-part="label"><strong>Apagado</strong></div><div class="line" data-step-id="off" data-step-part="instruction">Presione una vez</div></div></div></div></figure>
...
<img src="assets/ac_wall_37f4c64bfeaa.png" style="width: 360px;" width="360" height="144" alt="Diagrama de carga por toma de CA." />
...
<img src="assets/solar_direct_8332edf8c767.png" style="width: 360px;" width="360" height="158" alt="Diagrama de conexión para carga solar 1." />
...
<img src="assets/solar_adapter_cebf89383670.png" style="width: 360px;" width="360" height="166" alt="Diagrama de conexión para carga solar 2." />
