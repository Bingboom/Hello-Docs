...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{製品の名称} & \HBTypeSpecValue{Jackery ポータブル電源 900} \\
   \hline
   \HBTypeSpecLabel{型番} & \HBTypeSpecValue{JE-900B} \\
   \hline
   \HBTypeSpecLabel{定格容量} & \HBTypeSpecValue{960Wh (18.75Ah/51.2V DC)} \\
   \hline
   \HBTypeSpecLabel{バッテリータイプ} & \HBTypeSpecValue{LiFePO₄ (リン酸鉄リチウムイオン電池)} \\
   \hline
   \HBTypeSpecLabel{サイズ＆重量} & \HBTypeSpecValue{約314 × 201 × 234 mm（約10.6 kg）} \\
   \hline
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{3×ACポート} & \HBTypeSpecValue{100V\textasciitilde{}50Hz/60Hz，最大15A，定格1500W，瞬間最大3000W} \\
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">Jackery ポータブル電源 900</td>
          </tr>
          <tr>
            <th scope="row" class="hb-spec-label">型番</th>
            <td class="hb-spec-value">JE-900B</td>
          </tr>
          <tr>
            <th scope="row" class="hb-spec-label">定格容量</th>
            <td class="hb-spec-value">960Wh (18.75Ah/51.2V DC)</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="hb-spec-value">約314 × 201 × 234 mm（約10.6 kg）</td>
          </tr>
          <tr>
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">100V~50Hz/60Hz，最大15A，定格1500W，瞬間最大3000W</td>
          </tr>
          <tr>
