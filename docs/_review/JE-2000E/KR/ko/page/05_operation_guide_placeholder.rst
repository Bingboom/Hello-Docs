...
| 에너지 절약 모드가 활성화된 경우, AC1/2 출력 또는 DC/USB 출력이 켜져 있지만 제품이 충전 또는 방전 중이 아니면 12시간 후 자동으로 전원이 꺼집니다.
...
| AC1 전원 버튼은 AC 콘센트 1구를, AC2 전원 버튼은 나머지 AC 콘센트 2구를 제어합니다. 각 버튼을 누르면 해당 콘센트의 출력이 켜지거나 꺼집니다.
   ...
   .. list-table::
      ...
      * - **주의**
        -
          ...
          - Jackery Explorer 2000 Plus 리튬이차전지시스템은 IEC/EN/UL 62368-1(또는 기타 동등한 표준)의 6.3, 6.4 및 6.5항을 준수하는 기기 또는 액세서리에만 연결하십시오.
