...
2.2 장치의 전원 버튼을 눌러 전원을 켜십시오. 장치의 Wi-Fi 및 블루투스 아이콘이 깜박이면 네트워크 설정 모드에 진입했음을 의미합니다. "**Icon Flashed**" 버튼을 탭한 후, App이 주변 기기에 연결할 수 있도록 블루투스 권한을 허용하십시오.
...
.. list-table::
   ...
   * - **참고**
     - 바인딩 과정에서 "**이 기기가 연결되었습니다**" 메시지가 표시되면 다음 두 가지 방법으로 연결할 수 있습니다:
       ...
       - 전원 버튼 + DC/USB 전원 버튼을 3초 동안 길게 눌러 장치의 Wi-Fi 및 블루투스를 재설정한 후 장치를 다시 바인딩하십시오.
...
전원 버튼 + DC/USB 전원 버튼을 동시에 3초 동안 길게 눌러 Wi-Fi 및 블루투스를 공장 설정으로 재설정하십시오. 연결된 App 계정이 해제됩니다.
