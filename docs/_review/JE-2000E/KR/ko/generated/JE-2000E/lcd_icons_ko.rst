   ...
   .. list-table::
      ...
      * - 4
        - .. image:: _repo_assets/data/phase2/_attachments/lcd_icons/4_Charging_Plan_M96RbyZQxoGjRRxQHsuczeIln1b.png
             ...
             :width: 42px
        - 충전 계획
        - | Jackery Explorer 2000 Plus 리튬이차전지시스템의 충전 시간을 사용자 지정합니다. 전기 요금이 변동하는 상황에 적합하며, 피크 시간과 오프피크 시간에 따라 충전 계획을 세워 전기 요금을 절약할 수 있습니다.
          | 이 기능은 Jackery App에서 설정/해제할 수 있습니다. 이 설정은 장치 전원이 꺼져도 유지됩니다.
      * - 5
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdIconRow{4}{4_Charging_Plan_M96RbyZQxoGjRRxQHsuczeIln1b.png}{충전 계획}{Jackery Explorer 2000 Plus 리튬이차전지시스템의 충전 시간을 사용자 지정합니다. 전기 요금이 변동하는 상황에 적합하며, 피크 시간과 오프피크 시간에 따라 충전 계획을 세워 전기 요금을 절약할 수 있습니다. \newline 이 기능은 Jackery App에서 설정/해제할 수 있습니다. 이 설정은 장치 전원이 꺼져도 유지됩니다.}
      ...
      \clearpage
      \begin{HBLcdIconTable}
      \HBLcdIconRow{8}{8_AC_Power_Indicator_HFPSbvWBgosvCux69jMcuWe6nnh.png}{AC 전원 표시기}{AC 출력(순수 정현파)이 켜져 있습니다.}
