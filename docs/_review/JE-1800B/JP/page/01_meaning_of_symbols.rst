...
Jackery ポータブル電源 1800は、定格出力2200Wです。通常時で消費電力が2200Wまでの機器に給電ができるため、多くの電化製品や端末に対応可能です。ただし、電気モーターを搭載している製品（掃除機、ポンプ、冷蔵庫、電動丸ノコ、エアコン、洗濯機、電子レンジ、ドライヤーなど）は、起動時に「誘導負荷」が発生し、公称電力の3～7倍の電力が必要になる場合があります。

定格出力2200Wとは、一定の電力で動作する機器に対して安定して出力できる最大電力を指します。
