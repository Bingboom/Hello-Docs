...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \safetylead{ご使用の前にこの「安全上のご注意」をよくお読みのうえ、正しくお使いください。}
...
.. only:: html
   ...
   .. raw:: html
      ...
      <div class="hb-safety">
        ...
        <p class="hb-lead">ご使用の前にこの「安全上のご注意」をよくお読みのうえ、正しくお使いください。</p>
      </div>
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      {\color{white}\bfseries 絵表示について}
      \end{tcolorbox}
      \par\noindent 製品を安全に正しくお使いいただき、お客様や他の方々への危害や財産への損害を未然に防止するための表示です。
      \par\noindent 内容をよく理解してから本文をお読みください。
...
.. only:: html
   ...
   .. raw:: html
      ...
      <div class="hb-safety">
        <div class="hb-subbar">絵表示について</div>
        <p>製品を安全に正しくお使いいただき、お客様や他の方々への危害や財産への損害を未然に防止するための表示です。</p>
        <p>内容をよく理解してから本文をお読みください。</p>
      </div>
...
.. list-table::
   ...
   * - .. image:: _assets/templates/word_template/common_assets/symbols/unplug.png
     ...
     - 万が一、次のような異常が発生したときはすぐに使用をやめる
       ...
       すぐにAC充電ケーブルをコンセントから抜いてください。また、本製品に接続されている機器もすべて外してください。
...
.. list-table::
   ...
   * - .. image:: _assets/templates/word_template/common_assets/symbols/warning_triangle.png
          :alt: Caution icon.
          :width: 40px
     - **格納式ハンドルを使用してJackery ポータブル電源 1800を移動するときは、積み重ねたり、上に他の物を置いたりしないでください。落下して怪我をする場合があります。**

使用上のご注意
--------------

Jackery ポータブル電源 1800は、定格出力2200Wです。通常時で消費電力が2000Wまでの機器に給電ができるため、多くの電化製品や端末に対応可能です。ただし、電気モーターを搭載している製品（掃除機、ポンプ、冷蔵庫、電動丸ノコ、エアコン、洗濯機、電子レンジ、ドライヤーなど）は、起動時に「誘導負荷」が発生し、公称電力の3～7倍の電力が必要になる場合があります。

定格出力1500Wとは、一定の電力で動作する機器に対して安定して出力できる最大電力を指します。
接続する機器の消費電力が1500Wを超えた場合、保護機能が作動し、自動的に出力が停止することがあります。

また、本製品にはAC出力ポートが4つ搭載されていますが、複数の機器を同時に使用する場合でも、合計消費電力が2200W以内になるようにご確認ください。
