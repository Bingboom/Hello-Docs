...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBAppBody{\textbf{2.1} Haga clic en el botón \textbf{Añadir dispositivo}. \textbf{2.2} Presione una vez el botón de encendido principal del dispositivo. Los iconos del Wi-Fi y Bluetooth parpadearán; pulse el icono parpadeante y permita que la aplicación se conecte a los dispositivos cercanos y abra los permisos de Bluetooth.}
      ...
      \HBAppBody{\textbf{2.4} Una vez conectado el dispositivo, introduzca el nombre y la contraseña de la red Wi-Fi. El dispositivo se conectará automáticamente a la red Wi-Fi.}
      \HBAppNotice{NOTA}{Seleccione una red Wi-Fi de 2,4 GHz. El dispositivo no admite redes Wi-Fi de 5 GHz.}
      \HBAppBody{\textbf{2.5} Después de agregar el dispositivo en la App, el icono de Wi-Fi permanecerá encendido.}
      ...
      \HBAppBody{Abra \textbf{Configuración} en la esquina superior derecha de la interfaz principal y pulse \textbf{Desvincular} en la parte inferior de la página.}
      \HBAppStep{4.}{Notas}
      \HBAppBody{\textbf{4.1 Para activar Wi-Fi y Bluetooth:} encienda el dispositivo o pulse al mismo tiempo los botones de energía CC/USB y energía CA. \textbf{4.2 Para desactivarlos:} mantenga pulsados ambos botones hasta que se apaguen los iconos. \textbf{4.3 Para restablecerlos:} pulse el botón de encendido principal y el botón de energía CC/USB durante 3 segundos para restablecer los ajustes de fábrica. Se desvinculará la cuenta de la aplicación conectada.}
...
2.2 Presione una vez el botón POWER principal del dispositivo para encenderlo.
...
.. list-table::
   ...
   * - **NOTA**
     - Si durante el proceso de vinculación se indica que "el dispositivo ha sido vinculado", se pueden utilizar las dos formas siguientes para la conexión:
       ...
       - Mantenga pulsados el botón POWER principal y botón de encendido DC / USB durante 3 segundos para reiniciar el Wi‑Fi y el Bluetooth del dispositivo y, a continuación, vuelva a vincularlo.
...
- Pulse el botón de encendido DC / USB y botón CA al mismo tiempo hasta que se enciendan los iconos de wifi y Bluetooth en la pantalla.

4.2 Para desactivar Wi-Fi y Bluetooth
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Mantenga pulsados botón de encendido DC / USB y botón CA al mismo tiempo hasta que se apaguen los iconos de wifi y Bluetooth en la pantalla.

4.3 Para restablecer Wi-Fi y Bluetooth
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Pulsa el botón POWER principal y botón de encendido DC / USB al mismo tiempo durante 3 segundos para restablecer los ajustes de fábrica de Wi-Fi y Bluetooth. Se desvinculará la cuenta de la aplicación conectada.
