...
.. only:: model_je_2000e
   ...
   .. only:: region_us
      ...
      .. list-table::
         ...
         * - **CAUTION**
           - - Ensure all products are powered off before connecting Jackery Explorer 300 to the Jackery Battery Pack 2000.
...
.. list-table::
   ...
   * - **NOTE**
     - - The recommended charging temperature for the product ranges from 0 °C to 45 °C, and the discharging temperature ranges from -15 °C to 45 °C.
