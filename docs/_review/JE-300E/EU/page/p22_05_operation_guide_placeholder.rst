...
.. list-table::
   ...
   * - **ATTENTION**
     -
       ...
       - Ne connectez Jackery Explorer 300 qu'à des appareils ou accessoires conformes aux clauses 6.3, 6.4 et 6.5 de la norme IEC/EN/UL 62368-1 (ou autres normes équivalentes).
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdModeSecondGroup{Allumer en continu (en cours de charge ou de décharge)}{Allumer}{Appuyez deux fois sur le bouton POWER principal lorsque le produit est allumé.}{Éteindre}{Appuyez sur le bouton POWER principal.}{Arrêt automatique}{L'écran LCD s'éteint automatiquement après 2 heures d'inactivité.}
      \end{HBLcdModeTable}
