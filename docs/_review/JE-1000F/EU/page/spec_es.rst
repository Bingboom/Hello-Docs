...
.. raw:: latex
   ...
   \begin{spectable}
   \noindent\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}m{\csname HBcomp_spec_table_left_ratio\endcsname\linewidth}|>{\raggedright\arraybackslash}X@{}}
   \HBTypeSpecLabel{2 × Salidas CA} & \HBTypeSpecValue{230 V\textasciitilde{} 50 Hz, 12,5 A máx., 1500 W Nominal por puerto, 1500 W en Total, 3000 W Pico de sobrecarga} \\
   \hline
   \HBTypeSpecLabel{Salida de CA en modo bypass\HBSpecMarkerOne{}} & \HBTypeSpecValue{220 V-240 V\textasciitilde{} 50 Hz, 1500 W} \\
   \hline
   \HBTypeSpecLabel{1 × Salida USB-A} & \HBTypeSpecValue{18 W máx., 5-6 V⎓3 A, 6-9 V⎓2 A, 9-12 V⎓1,5 A} \\
   \hline
   \HBTypeSpecLabel{1 × Puerto DC 12 V} & \HBTypeSpecValue{12 V⎓10 A máx.} \\
   \end{tabularx}
   \end{spectable}
...
.. raw:: latex
   ...
   \begin{spectable}
   \noindent\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}m{\csname HBcomp_spec_table_left_ratio\endcsname\linewidth}|>{\raggedright\arraybackslash}X@{}}
   \HBTypeSpecLabel{Temperatura de carga} & \HBTypeSpecValue{-10 °C a 45 °C} \\
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          ...
          <tr>
            ...
            <td class="hb-spec-value">Aproximadamente 10,6 kg</td>
          </tr>
          <tr>
      ...
      <table class="hb-spec-table">
        <tbody>
          ...
          <tr>
            ...
            <td class="hb-spec-value">11 V-16 V⎓8 A máx., Doble a 8 A máx.<br/>16 V-60 V⎓12 A, Doble hasta 21 A / 400 W máx.</td>
          </tr>
        </tbody>
      </table>
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">230 V~ 50 Hz, 12,5 A máx., 1500 W Nominal por puerto, 1500 W en Total, 3000 W Pico de sobrecarga</td>
          </tr>
          <tr>
