...
.. raw:: latex
   ...
   \begin{spectable}
   \noindent\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}m{\csname HBcomp_spec_table_left_ratio\endcsname\linewidth}|>{\raggedright\arraybackslash}X@{}}
   \HBTypeSpecLabel{充電温度} & \HBTypeSpecValue{-10℃ \textasciitilde{} 45℃} \\
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">100V-120V~50Hz/60Hz, 最大15A①<br/>バススルー②: 100V-120V~ 50Hz/60Hz，最大15A</td>
          </tr>
          <tr>
