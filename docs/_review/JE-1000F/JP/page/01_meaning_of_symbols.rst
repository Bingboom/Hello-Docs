...
Jackery ポータブル電源 1000 New は、定格出力1500Wです。通常時で消費電力が1500Wまでの機器に給電ができるため、多くの電化製品や端末に対応可能です。ただし、電気モーターを搭載している製品（掃除機、ポンプ、冷蔵庫、電動丸ノコ、エアコン、洗濯機、電子レンジ、ドライヤーなど）は、起動時に「誘導負荷」が発生し、公称電力の3～7倍の電力が必要になる場合があります。
...
- 本機は-10℃ ~ 45℃の温度範囲でお使いの機器に電力供給が可能となり、本機の蓄電は-10℃ ~ 45℃で行えます。
