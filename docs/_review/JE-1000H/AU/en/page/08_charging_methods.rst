...
It is recommended to use the Jackery solar panel to charge the product. Ensure that the open-circuit voltage (V\ :sub:`oc`) of the solar panel is within the DC input range (16V-60V) of Jackery Explorer 1000 Plus. Jackery is not responsible for any damage or loss resulting from the use of third-party solar panels.
