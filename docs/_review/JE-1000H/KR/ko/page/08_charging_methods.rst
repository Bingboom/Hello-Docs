...
Jackery Explorer 1000 Plus 리튬이차전지시스템은(는) 두 개의 DC8020 입력 포트를 갖추고 있으며 Jackery 태양광 패널과 호환됩니다.
...
제품 충전에는 Jackery 태양광 패널 사용을 권장합니다. 사용 중인 태양광 패널의 개방 회로 전압(V\ :sub:`oc`)이 Jackery Explorer 1000 Plus 리튬이차전지시스템의 DC 입력 범위(16V-60V) 내에 있는지 확인하십시오. 타사 태양광 패널 사용으로 인해 발생한 손상 또는 손실에 대해 Jackery는 책임을 지지 않습니다.
...
.. list-table::
   ...
   * - **주의**
     -
       - 파워 스테이션을 충전하기 전에 차량의 시동을 먼저 켜십시오.
