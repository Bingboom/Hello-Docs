...
.. only:: not latex
   ...
   .. list-table::
      ...
      * - 21
        - .. image:: _repo_assets/data/phase2/_attachments/lcd_icons/21_Connected_Batteries_ZeHlbv3HEoRcq2xIXacchUcTndg.png
             :alt: 연결된 배터리
             :width: 42px
        - 연결된 배터리
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdIconRow{1}{1_Wi-Fi_KCcAbdDk7o4RjKx82micuKJ5nyf.png}{Wi-Fi}{\textbf{켜짐:} Wi-Fi에 연결되었습니다. \newline 깜박임: Wi-Fi에 연결할 준비가 되었습니다. \newline \textbf{꺼짐:} Wi-Fi 연결이 해제되었습니다.}
      ...
      \HBLcdIconRow{4}{4_Charging_Plan_M96RbyZQxoGjRRxQHsuczeIln1b.png}{충전 계획}{Jackery Explorer 1000 Plus 리튬이차전지시스템의 충전 시간을 사용자 지정합니다. 전기 요금이 변동하는 상황에 적합하며, 피크 시간과 오프피크 시간에 따라 충전 계획을 세워 전기 요금을 절약할 수 있습니다. \newline 이 기능은 Jackery App에서 설정/해제할 수 있습니다. 이 설정은 장치 전원이 꺼져도 유지됩니다.}
      \HBLcdIconRow{5}{5_Self-powered_Mode_FYTnb9vttoexjbxVMchcJaobnCg.png}{자체 전원 모드}{저장된 태양광 에너지를 우선 사용하여 태양광 에너지 활용을 극대화하고 전력망 의존도를 낮춰 전기 요금을 절감합니다. 파워 스테이션은 태양광 패널과 전력망에 동시에 연결되어야 하며, 부하 전력은 바이패스 전력 한도로 제한됩니다. \newline 이 기능은 Jackery App에서 설정/해제할 수 있습니다. 장치 전원이 꺼져도 이 설정은 유지됩니다.}
      ...
      \HBLcdIconRow{7}{7_UPS_Lgdgb8pvvoGwaLxSf8ec2QeHn3c.png}{UPS}{\textbf{켜짐:} 제품이 바이패스 모드로 작동 중입니다. AC 포트에 연결된 부하는 파워 스테이션이 아닌 전력망에서 전력을 소비합니다. 그리드 전력이 갑자기 중단되면 제품은 10 ms 이내에 자동으로 배터리 전력으로 전환됩니다. \newline \textbf{꺼짐:} 제품은 바이패스 모드에서 작동하지 않습니다. AC 포트에 연결된 부하는 파워 스테이션의 내부 배터리에서 전원을 공급받습니다.}
      \end{HBLcdIconTable}
      \clearpage
      \begin{HBLcdIconTable}
      \HBLcdIconRow{8}{8_AC_Power_Indicator_HFPSbvWBgosvCux69jMcuWe6nnh.png}{AC 전원 표시등}{AC 출력(순수 정현파)이 켜져 있습니다.}
      \HBLcdIconRow{9}{9_Output_Voltage_and_Frequency_Jh3JbmBDBoKlmOxaRJDcIMJAn6b.png}{출력 전압 및 주파수}{AC 출력이 켜져 있을 때 출력 전압과 주파수를 표시합니다.}
      \HBLcdIconRow{10}{10_Input_Power_LOAZbnxfqoHFwIxx2Myc532jnzb.png}{입력 전력}{입력 전력을 와트(W) 단위로 표시합니다.}
      \HBLcdIconRow{11}{11_Remaining_Charge_Time_KIWHbHFOvotGuBxJsxlcunSDnPf.png}{남은 충전 시간}{남은 충전 시간을 표시합니다.}
      \HBLcdIconRow{12}{12_AC_Wall_Charging_Indicator_ZpOmbCjx8oYUTVxyl4JcvcTanPe.png}{AC 벽면 충전 표시기}{제품은 그리드 전력을 사용하여 AC 입력 포트를 통해 충전됩니다.}
      ...
      \HBLcdIconRow{17}{17_Battery_Power_Indicator_VLufb9exvoVLfgxz47pcfnRGnaf.png}{배터리 전력 표시등}{제품이 충전 중일 때 배터리 백분율 주위의 주황색 원이 순차적으로 점등됩니다. 다른 기기를 충전할 때는 주황색 원이 계속 켜져 있습니다.}
      ...
      \HBLcdIconRow{26}{26_Output_Power_PviebR618oofvKxcKVRcHLlInqd.png}{출력 전력}{출력 전력을 와트(W) 단위로 표시합니다.}
      \end{HBLcdIconTable}
      \clearpage
      \begin{HBLcdIconTable}
      \HBLcdIconRow{27}{27_Remaining_Discharge_Time_JEpobf59DoBV4dxWlnxcNtIinke.png}{잔여 방전 시간}{남은 방전 시간을 표시합니다.}
      \end{HBLcdIconTable}
