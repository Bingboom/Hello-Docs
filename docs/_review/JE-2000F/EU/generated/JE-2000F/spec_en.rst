...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{Product Name} & \HBTypeSpecValue{Jackery Explorer 2000} \\
   \hline
   \HBTypeSpecLabel{Model No.} & \HBTypeSpecValue{JE-2000F} \\
   \hline
   \HBTypeSpecLabel{Capacity} & \HBTypeSpecValue{2048 Wh (40 Ah / 51.2 V ⎓)} \\
   \hline
   \HBTypeSpecLabel{Cell Chemistry} & \HBTypeSpecValue{LiFePO₄} \\
   \hline
   \HBTypeSpecLabel{Weight} & \HBTypeSpecValue{About 18.5 kg} \\
   \hline
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{1 × AC Input} & \HBTypeSpecValue{Charge Mode: 220 V-240 V\textasciitilde{} 50 Hz, 10 A max. \newline Bypass Mode\HBSpecMarkerOne{}: 220 V-240 V\textasciitilde{} 50 Hz, 10 A max.} \\
   \hline
   \HBTypeSpecLabel{2 × DC8020 Ports} & \HBTypeSpecValue{Vehicle: 11 V-16 V⎓8 A max., Double to 8 A max. \newline PV: 16 V-60 V⎓12 A, Double to 21 A max. / 400 W max.} \\
   \end{spectable}
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{3 × AC} & \HBTypeSpecValue{230 V\textasciitilde{} 50 Hz, 10 A max., 2200 W rated in total, 4400 W surge peak} \\
   \hline
   \HBTypeSpecLabel{AC Output in Bypass Mode\HBSpecMarkerOne{}} & \HBTypeSpecValue{220 V-240 V\textasciitilde{} 50 Hz, 10 A max.} \\
   \hline
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{Charging Temperature} & \HBTypeSpecValue{0 °C to 45 °C} \\
   \hline
   \HBTypeSpecLabel{Discharging Temperature} & \HBTypeSpecValue{-10 °C to 45 °C} \\
   \end{spectable}
      ...
      <table class="hb-spec-table">
        <tbody>
          ...
          <tr>
            ...
            <td class="hb-spec-value">About 18.5 kg</td>
          </tr>
          <tr>
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">Charge Mode: 220 V-240 V~ 50 Hz, 10 A max.<br/>Bypass Mode①: 220 V-240 V~ 50 Hz, 10 A max.</td>
          </tr>
          <tr>
            <th scope="row" class="hb-spec-label">2 × DC8020 Ports</th>
            <td class="hb-spec-value">Vehicle: 11 V-16 V⎓8 A max., Double to 8 A max.<br/>PV: 16 V-60 V⎓12 A, Double to 21 A max. / 400 W max.</td>
          </tr>
        </tbody>
      </table>
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">230 V~ 50 Hz, 10 A max., 2200 W rated in total, 4400 W surge peak</td>
          </tr>
          <tr>
