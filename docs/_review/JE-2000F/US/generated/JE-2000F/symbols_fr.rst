...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBSymbolSignalRow{mandatory.png}{CONSEIL}{Complète les informations importantes ou les conseils d'utilisation dans le texte.}
      }
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBSymbolTable{Symbole}{Signification}{%
      \HBSymbolIconRow{1_warning_triangle_CppWbDvpZouM0OxPmyacMNt1nMh.png}{Symboles d’avertissement et de mise en garde. Signalent aux personnes des informations qui doivent être lues afin d’éviter les dangers ou risques potentiels.}
      \HBSymbolIconRow{7_do_not_dismantle_Tp4cbUNyQo0KytxtFaNcRyOQnEd.png}{Ne démontez pas le produit.}
      \HBSymbolIconRow{2_read_manual_GwHdbgaO4ognLjxnngBcttelnRa.png}{Lire le manuel de l'opérateur}
      \HBSymbolIconRow{8_no_open_flame_MV1ebyVJ9oTmIpxA2NzcV8agnad.png}{Tenir le produit à l’écart du feu.}
      \HBSymbolIconRow{3_electric_shock_MGNJbjVKeo7JpqxxFv0czlC6ntz.png}{Risque de choc électrique}
      \HBSymbolIconRow{9_keep_away_from_children_EkuMbUU1foXNPuxytfLcW9dinFS.png}{Les enfants ne sont pas admis}
      \HBSymbolIconRow{4_battery_charging_FQ3hbEyDxoXBNtxkV6OcKqrdnXg.png}{Chargement de la batterie}
      \HBSymbolIconRow{10_li_ion_V699bWppsoqekPxvtrccpM9dnDg.png}{Ce symbole indique que le produit contient une batterie lithium-ion (Li-ion), qui doit être éliminée ou recyclée de manière appropriée.}
      \HBSymbolIconRow{5_explosive_material_U5Hzbr3Xoo9ynmxwAXAcEu29nqg.png}{Matière explosive}
      \HBSymbolIconRow{11_weee_Ph50b51y0obEXBxibqGczTSbngc.png}{Ce symbole indique que le produit ne doit pas être jeté avec les ordures ménagères. Il doit être apporté à un point de collecte désigné pour un recyclage approprié. \newline Une élimination et un recyclage corrects contribuent à la protection de l’environnement. Pour plus d’informations, veuillez contacter votre autorité locale, le service de gestion des déchets ou le revendeur du produit.}
      \HBSymbolIconRow{6_heavy_object_QVtpblhGBoTYWwxHNbQchzawnro.png}{Objet lourd}
      \HBSymbolIconRow{12_weee2_B9TsbhWGfoYbwvxFMv5cHYnunWb.png}{Les piles et accumulateurs ne doivent pas être jetés avec les ordures ménagères. \newline En tant que consommateur, vous êtes légalement tenu de déposer toutes les piles et accumulateurs dans des points de collecte désignés, qu'ils contiennent ou non des substances dangereuses. \newline Veuillez rapporter les piles et accumulateurs usagés à un point de collecte local, un centre de recyclage ou au détaillant où ils ont été achetés. Une élimination appropriée garantit un recyclage respectueux de l'environnement et prévient les dommages potentiels pour la santé humaine et l'environnement.}
      }
