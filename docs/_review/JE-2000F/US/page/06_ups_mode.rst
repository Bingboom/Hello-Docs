...
| In the event of a sudden loss of grid power, Jackery HomePower 2000 Plus will automatically switch to stored power within 10 ms to keep your appliances running.
| In UPS mode, the unit's peak output reaches 12A (1440W) before power outages. As simultaneous charging/discharging is enabled in Bypass Mode,
